...
- **Gruppenarbeit**: Die Schüler*innen werden in kleine Gruppen aufgeteilt und erhalten die Aufgabe, Alltagsbeispielen zu identifizieren, die das EVA-Prinzip verdeutlichen (z.B. Taschenrechner, Ampelanlage).
- **Diskussion**: Gemeinsames Durchgehen der von den Schülerinnen und Schülern erarbeiteten Alltagsbeispielen.
...
- **Grundsätzliches Prinzip einer Verarbeitung**:
  ...
  - **Recheneinheit**: Erklärung, dass die Recheneinheit den aktuellen Befehl ausführt. Ein Befehl kann das Berechnen einer Rechenaufgabe sein, das Ausgeben eines Buchstaben auf dem Bildschirm, oder das Einlesen einer Mausbewegung.
  - **Datenspeicher**: Erklärung, dass im Datenspeicher Ergebnisse von Berechnungen abgelegt werden oder Bilder, Dokumente oder ähnliches abgelegt werden kann.

Das Arbeitsprinzip kann an einem Beispiel erklärt werden bei dem im Programmspeicher eine Befehlsfolge abgearbeitet werden soll in der zwei Zahlen aus den Datenspeicher geladen werden sollen, in der Recheneinheit addiert werden und anschließend an eine dritte Stelle im Datenspeicher gespeichert werden soll.

- **Rechnerarchitektur eines modernen Personal Computers**:
  - **Gemeinsamer Daten Programm und Datenspeicher**: Erklärung, dass modere Personal Computer (PC) nach der *Von-Neumann-Architektur* aufgebaut sind. In dieser Architektur existiert ein gemeinsamer Speicher, der sowohl die Computerprogrammbefehle als auch die Daten speichert.
  - **Unterscheidung von schnellen flüchtigen und langsamen nicht-flüchtigen Speicher**: Erklärung, dass zwei Typen von Speicher in PCs vorgehalten werden. Einen schnellen flüchtigen Speicher, den sogenannten Arbeitsspeicher und einen nicht-flüchtigen langsamen Speicher, die sogenannte Festplatte. Flüchtiger Speicher bedeutet, dass die Daten nach dem ausschalten des Rechners verloren gehen. Nicht-flüchtiger Speicher behält seine Daten auch, wenn der PC ausgeschaltet ist. Das Programm und die zu bearbeiten Daten werden in der Regel erst in den Arbeitsspeiche kopiert und dann fängt der Rechner an das Programm abzuarbeiten. 
...
## Funktion und Zusammenwirken von Computerkomponenten

### Unterrichtsentwurf: Funktion und Zusammenwirken von Computerkomponenten
...
- **Dokumentation der Recherche**: Jede Gruppe erstellt Dokumentation ihrer Recherche. Dies kann in Form einer kurze Präsentation (z.B. auf einem Plakat oder in einer PowerPoint-Präsentation) sein oder in einem Word-Dokument.

#### 4. Präsentation und Diskussion (20 Minuten)
- **Präsentation der Gruppenarbeiten**: Eine Gruppe präsentiert ihre Ergebnisse vor der Klasse.
- **Diskussion**: Nach der Präsentation gibt es eine kurze Diskussionsrunde, in der Fragen gestellt und Unklarheiten geklärt werden können.
...
## Computer zerlegen, dokumentieren und wieder zusammenbauen
...
## Reflexion und Analogie zu anderen Geräten
...
#### 1. Einstieg (10 Minuten)
- **Begrüßung und Zielsetzung**: Begrüßung der Schülerinnen und Schüler und Vorstellung der heutigen Lernziele.
...
- **Materialverteilung**: Austeilen von Tablets oder die Zuweisung von PCs an den die Präsentation erstellt werden kann.
- **Plakaterstellung**: Die Schüler*innen arbeiten in Gruppen und gestalten ihr Plakat. Dabei sollen sie:
...
### Materialien
- Tablet oder PCs
- Gesicherte Fotos und Notizen der letzten Stunden. 
...
* Die Schülerinnen und Schüler verwenden die nötige Fachsprache.
* Die Schülerinnen und Schüler diskutieren Informatikmodelle.
* Die Schülerinnen und Schüler präsentieren Unterrichtsergebnisse und diskutieren diese.

## Inhaltsbezogene Kompetenzen

### Sekundarstufe I

|Nr.| Die Schülerinnen und Schüler ... | Inhalte|
|---|---|---|
...
|I7|...  nennen Hardwarekomponenten und ihre Funktion.|Hardware, Sensoren und Eingabegeräte, Prozessoren, Befehlszyklus, Speicher, flüchtiger und permanente Speicher, Netzwerkkomponenten, Aktoren und Ausgabegeräte|
